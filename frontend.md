...
### Job
```ts
type JobStatus = 'scheduled' | 'confirmed' | 'in_progress' | 'completed' | 'canceled' | 'no_show';
...
### AutomationRule
```ts
type AutomationTrigger = 'job_created' | 'job_reminder_24h' | 'job_completed' | 'invoice_overdue';
